...
appBaztille.controller('QuestionCtrl', function(Questions, UxQuestions, $scope,$state, $location, $ionicSideMenuDelegate, $window, $ionicLoading, $ionicModal, $http, $stateParams, $ionicPopup, $ionicPopover) {
