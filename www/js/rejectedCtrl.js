...
appBaztille.controller('RejectedCtrl', function(Questions, $scope, $state, $ionicLoading,  $ionicModal, $window, $ionicHistory, $ionicSideMenuDelegate, $http) {
